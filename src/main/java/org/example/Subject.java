...
public class Subject {
    public static void insertsubjects(String tableName, Map<String, String> fieldValues, Connection connection) {
        try {
...
//    public static void updateSubjects(String tableName, String idColumn, int idValue, Map<String, String> fieldValues, Connection connection) {
//        try {
...
//    }
    ...
    public static JSONArray selectSubjects(Connection connection, String tableName, List<String> columns,
