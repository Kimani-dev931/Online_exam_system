...
//    public static void Insertoptions(String tableName, Map<String, String> fieldValues, Connection connection) {
//        try {
...
//    }
    ...
    public static Response insertoptions(String tableName, Map<String, String> fieldValues, Connection connection) {
        try {
            String insertSQL = QueryManager.constructInsertStatement(tableName, fieldValues);
...
//
//   public static void updateOptions(String tableName, String idColumn, int idValue, Map<String, String> fieldValues, Connection connection) {
//     try {
...
//}
    ...
    public static Response updateOptions(String tableName, String idColumn, int idValue, Map<String, String> fieldValues, Connection connection) {
        try {
            boolean useCurrentTimestamp = "CURRENT_TIMESTAMP".equals(fieldValues.get("date_modified"));
            String updateSQL = QueryManager.constructUpdateStatement(tableName, idColumn, idValue, fieldValues, useCurrentTimestamp);
            PreparedStatement preparedStatement = connection.prepareStatement(updateSQL);
...
//    public static JSONArray selectOptions(Connection connection, String tableName, List<String> columns,
...
//        return QueryManager.dynamicSelect(connection, tableName, columns, whereClause, groupBy,havingClause, orderBy, limit, joinClauses,databaseType,offset);
//    }

    public static Response selectOptions(Connection connection, String tableName, List<String> columns,
                                         String whereClause, String groupBy, String orderBy, String havingClause, Integer limit, Integer offset,
                                         List<String> joinClauses, String databaseType) throws SQLException {
