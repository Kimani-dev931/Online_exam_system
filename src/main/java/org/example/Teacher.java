...
//    public static void executeteacher(String tableName, Map<String, String> fieldValues, Connection connection) {
//        try {
...
//    public static void updateTeacher(String tableName, String idColumn, int idValue, Map<String, String> fieldValues, Connection connection) {
//        try {
...
//    public static JSONArray selectTeacher(Connection connection, String tableName, List<String> columns,
