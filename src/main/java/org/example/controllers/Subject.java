...
//        }
//    }
    public static Response insertsubjects(String tableName, Map<String, String> fieldValues) {
    ...
    public static Response updateSubjects(String tableName, String idColumn, int idValue, Map<String, String> fieldValues) {
        Connection connection = null;
        try {
            connection = database_connection.getConnection();
...
//    }
    public static Response selectSubjects(String tableName, List<String> columns, String whereClause, String groupBy, String orderBy, String havingClause, Integer limit, Integer offset, List<String> joinClauses, String databaseType, Map<String, String> likeConditions) {
        Connection connection = null;
        try {
            connection = database_connection.getConnection();
            Object data = QueryManager.dynamicSelect(connection, tableName, columns, whereClause, groupBy, orderBy, havingClause, limit, joinClauses, databaseType, offset, likeConditions);
