...
//                Response response = Responses.selectResponses(connection,"Responses",null,null,null,null,null,null,null,null,null,null);
...
//            }
//
//            List<String> columns = Arrays.asList("response_id", "questions_id", "student_id", "option_id", "date_created");
//
//            String orderBy = "response_id";
//            // Existing logic to construct likeConditions and fetch data...
//
//            exchange.getRequestReceiver().receiveFullString((exchange1, message) -> {
//                try {
//                    // Fetch data and handle empty result set
//                    Response response = dynamic_controller.select( "Responses", columns, null, null, orderBy, null, pageSize, offset, null, null, likeConditions);
        ...
        try {
            ...
            exchange.getRequestReceiver().receiveFullString((exchange1, message) -> {
                try {
                    ...
                    Response response = Dynamic_Controller.select("Responses", columns, whereClause, null, orderBy, null, finalPageSize, offset, null, null, null);
                    List<String> column=Arrays.asList("count(*)");

                    Response countResponse = Dynamic_Controller.select("Responses",column , whereClause, null, null, null,null, null, null, null, null);
